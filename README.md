...
It's possible to retrieve partial results from the result in rder to personnalize more precisely the structure. Apache commons Bean Utils syntax applies.
